!(function () {
    ...
    function b(t, n, r) {
        ...
        g && Object.defineProperty(s, g, { value: "Module" });
        ...
        return (i = t[m][n] = { id: n, i: o, n: s, I: u, L: c, h: !1, d: void 0, e: void 0, er: void 0, E: void 0, C: void 0, p: void 0 });
    }
    function O(e, t, n, r) {
        if (!r[t.id])
            return (
    ...
    if (
        ...
        i && (L(), window.addEventListener("DOMContentLoaded", L)),
        i)
    ) {
    ...
    (w.instantiate = function (t, n) {
        ...
        return this.shouldFetch(t)
            ? this.fetch(t, { credentials: "same-origin", integrity: M.integrity[t] }).then(function (i) {
                ...
                return s(t, n).then(function (n) {
                    ...
                    return r.test(s)
                        ...
                        ? n.text().then(function (e) {
                              return new Response(
                                  new Blob(["System.register([],function(e){return{execute:function(){var s=new CSSStyleSheet();s.replaceSync(" + JSON.stringify(e) + ');e("default",s)}}})'], { type: "application/javascript" })
                              );
                          })
                        : o.test(s)
                        ? (WebAssembly.compileStreaming ? WebAssembly.compileStreaming(n) : n.arrayBuffer().then(WebAssembly.compile)).then(function (n) {
    ...
    (w.get = function (e) {
        ...
        (w.set = function (e, t) {
            var n;
            $ && "Module" === t[$] ? (n = t) : ((n = Object.assign(Object.create(null), t)), $ && Object.defineProperty(n, $, { value: "Module" }));
            var r = Promise.resolve(n),
                i = this[m][e] || (this[m][e] = { id: e, i: [], h: !1, d: [], e: null, er: void 0, E: void 0 });
